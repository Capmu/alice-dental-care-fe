    ...
    return(
      ...
      <div className="login-right">
        <div className="login-box">
          ...
          <h1 className="text-primary mt-4 mb-1 text-start">Alice Dental Care</h1>
          ...
          <div className="form-group mt-4">
            ...
            <button type="button" className="btn btn-primary" onClick={() => {window.location.href = "http://localhost:5001/api/v1/auth/google";}}>
              <FcGoogle />
              Sign in with Google
            </button>
          </form>
          ...
          <p className="signup-text">
            Don't have an account? <a className="text-primary" href="/">Sign up now</a>
          </p>
        </div>
