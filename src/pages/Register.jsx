        ...
        <>
            ...
            <section className='form'>
                <form onSubmit={onSubmit}>
                    ...
                    <div className="form-group">
                        <input type="password" className='formcontrol' id='password' name='password' value={password} onChange={onChange} placeholder='Enter Your password' required/>
                    </div>
                    <div className="form-group">
                        <input type="password" className='formcontrol' id='password2' name='password2' value={password2} onChange={onChange} placeholder='Confirm Your password' required/>
                    </div>
                    <div className="form-group">
